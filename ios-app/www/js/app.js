  ...
  function editorHTML(kids) {
    ...
    return `
      <div class="ed-top">
        ...
        <div class="sp"></div>
        <button class="icon-btn zoom-ctl" onclick="CV.zoom(-1)" title="Zoom out">${ICONS.zoomOut}</button>
        <span id="zoomLvl" class="zoom-ctl" style="font-size:12px;font-weight:600;color:var(--ink-3);min-width:42px;text-align:center">100%</span>
        <button class="icon-btn zoom-ctl" onclick="CV.zoom(1)" title="Zoom in">${ICONS.zoom}</button>
        <button class="btn btn-primary btn-sm" onclick="CV.save()" style="margin-left:6px" title="Save">${ICONS.download}<span style="margin-left:4px">Save</span></button>
        <button class="btn btn-success btn-sm" onclick="CV.exportModal()" style="margin-left:6px" title="Export">${ICONS.share}<span style="margin-left:4px">Export</span></button>
      </div>
      <div class="ed-body">
        <div class="ed-rail">
          ...
          ${kids ? '' : `<div class="rail-gap" style="height:8px"></div>
            <select id="brushSel" class="brush-sel" onchange="CV.setBrush(this.value)">
